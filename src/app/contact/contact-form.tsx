...
const faqItems = [
  { question: "How can I contact doubleclick iptv?", answer: "All doubleclick iptv support is via WhatsApp at +44 7460 006846. It is the fastest way to get a response within 30 minutes." },
  ...
  { question: "How do I get a doubleclick iptv subscription?", answer: "Contact us directly via WhatsApp at +44 7460 006846 to choose your plan and receive your credentials. We will guide you through the process." },
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 mx-auto max-w-2xl">
            <div className="rounded-2xl border border-border bg-card p-8 text-center">
              ...
              <p className="mt-2 text-lg text-muted-foreground">
                <span className="text-white font-semibold">+44 7460 006846</span>
              </p>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3 max-w-3xl mx-auto">
            ...
            <div className="rounded-2xl border border-border bg-card p-6 text-center">
              ...
              <p className="mt-1 text-sm text-muted-foreground">+44 7460 006846</p>
